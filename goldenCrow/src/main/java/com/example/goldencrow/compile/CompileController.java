...
public class CompileController {
     ...
     */
    @PostMapping("/py")
    public ResponseEntity<Map<String, String>> pyCompile(@RequestHeader("Authorization") String jwt, @RequestBody Map<String, Object> req) {

        if(req.containsKey("type") && req.containsKey("projectName") && req.containsKey("teamSeq") && req.containsKey("input")) {
     ...
     */
    @PostMapping("/py/stop")
    public ResponseEntity<Map<String, String>> pyCompileStop(@RequestHeader("Authorization") String jwt, @RequestBody Map<String, String> req) {
