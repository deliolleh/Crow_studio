...
const PasswordForm = ({ onSubmitModifiedNickname }) => {
  ...
  const submitHandler = (e) => {
    ...
    // const modifiedNicknameData = { userNickname: inputNickname };
    setErrMsg("");
    // onSubmitModifiedNickname(JSON.stringify(modifiedNicknameData));
  };
