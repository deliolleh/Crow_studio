...
const Profile = ({ openModify, userSeq }) => {
  ...
  return (
    <div className="md:w-80 sm:w-[600px] w-[400px] h-96 sm:h-80 flex justify-center items-center border border-primary_-2_dark rounded-md md:mr-2 md:mb-0 sm:mr-0 sm:mb-2 mb-2">
