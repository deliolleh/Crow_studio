...
const SelectMethod = ({ onMethodChange }) => {
  ...
  return (
    <>
      ...
      <Combobox value={selected} onChange={setSelected} defaultValue="GET" className="mb-5">
        <div className="relative mt-1">
          <div 
          className="relative flex justify-between items-center rounded-md bg-component_item_bg_+2_dark px-4 py-2 text-xs font-medium text-white text-left shadow-sm hover:bg-point_purple_op20 active:outline-none active:ring-2 active:ring-point_purple" style={{ height: 26, width: 217 }}>
            <Combobox.Input
          ...
          >
            ...
            className="absolute left-[107px] z-10 mt-0.5 origin-top-right rounded-md bg-component_item_bg_+2_dark shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" style={{ height: 104, width: 217 }}
            >
