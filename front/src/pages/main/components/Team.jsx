        ...
        <div className="" style={{ padding: 15 }}>
          <div className="pl-1">
            ...
            <div className="flex items-center text-sm mb-2">
              <img className="rounded-full flex my-2 mr-4" style={{ width: 45, height: 45 }} src={require('../../../assets/images/avatar.png')} />
              <div>박자연</div>
            </div>
            <div className="text-primary_dark text-sm font-bold">팀원</div>
            <div className="flex items-center text-sm">
              <img className="rounded-full flex mt-2 mb-0.5 mr-4" style={{ width: 45, height: 45 }} src={require('../../../assets/images/avatar.png')} />
              <div>김수빈</div>
            </div>
            <div className="flex items-center text-sm">
              <img className="rounded-full flex mt-2 mb-0.5 mr-4" style={{ width: 45, height: 45 }} src={require('../../../assets/images/avatar.png')} />
